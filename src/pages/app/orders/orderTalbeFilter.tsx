...
export function OrderTableFilter(){
    ...
    return(
        <form onSubmit={handleSubmit(handleFilter)} className="flex items-center gap-2">
            ...
            <Input {...register('orderId')} placeholder="ID do cliente" className="text-muted-foreground font-medium h-8 w-auto mb-[5px] ml-[5px] p-[10px]" type="text" />
            <Input {...register('customerName')} placeholder="Nome do cliente" className="text-muted-foreground font-medium h-8 w-[320px] mb-[5px] ml-[5px] p-[10px]" type="text" />
           <Controller name='status' control={control} render={({field:{name, onChange, value, disabled}})=>{
            ...
            <Button className="border-none mb-[5px] ml-[5px] p-[5px]" type="submit" size='xs'>
                <Search className="h-4 w-4 mr-2"/>
                Filtrar resultados
            </Button>
            <Button onClick={handleClearFilters} className="mb-[5px] ml-[5px] p-[5px] border-none" type="button" variant='error' size='xs'>
